...
## The plan is a client side C# dot net application with a Rust server side API. Since identity sort of matters, I may add in Duende/IdentityServer if I can't find something else that I can implement.
